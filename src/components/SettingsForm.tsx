        ...
        <details className={cn(
          ...
          <div className="px-4 pb-4 pt-3 space-y-4">
            <p className={cn(
              ...
              Switch assistant behavior by selecting a profile. The active profile prompt is prepended to your system prompt.
            </p>
            ...
            <div className="space-y-2">
              {formData.promptProfiles.map((profile) => (
                <div
                  key={profile.id}
                  className={cn(
                    'flex items-start justify-between p-2 rounded-lg',
                    formData.activePromptProfileId === profile.id
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <div className={cn(
                      ...
                      {profile.prompt.slice(0, 80)}{profile.prompt.length > 80 ? '...' : ''}
                    </div>
                  </div>
                  <div className="flex gap-1 ml-2 flex-shrink-0">
                    <button
                      ...
                      onClick={() => {
                        ...
                        setProfileDraft({ name: profile.name, prompt: profile.prompt });
                        setProfileError(null);
                      }}
                      className={cn(
            ...
            {editingProfile ? (
              <div className={cn(
                ...
                <Input
                  ...
                  onInput={(e) => {
                    setProfileDraft(prev => ({ ...prev, name: (e.target as HTMLInputElement).value }));
                    setProfileError(null);
                  }}
                  placeholder="Profile name"
                />
                <div>
                  <label htmlFor="profilePrompt" className={cn(
                    'block text-sm font-medium mb-1',
                    'text-text-primary dark:text-text-primary-dark'
                  )}>Prompt</label>
                  <textarea
                    ...
                    onInput={(e) => {
                      setProfileDraft(prev => ({ ...prev, prompt: (e.target as HTMLTextAreaElement).value }));
                      setProfileError(null);
                    }}
                    rows={4}
                    className={cn(
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    type="button"
                    variant="secondary"
                    onClick={() => { setEditingProfile(null); setProfileDraft({ name: '', prompt: '' }); setProfileError(null); }}
                  >
                    Cancel
                  </Button>
                </div>
              ...
              <div className={cn(
                ...
                />
                <div>
                  <label htmlFor="newProfilePrompt" className={cn(
                    'block text-sm font-medium mb-1',
                    'text-text-primary dark:text-text-primary-dark'
                  )}>Prompt</label>
                  <textarea
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex-1"
                    disabled={!profileDraft.name.trim() || !profileDraft.prompt.trim()}
                  >
                    Add Profile
                  </Button>
                  <Button
